...
import { removeFromCart, clearCart, increment, decrement } from "../redux/actions/cartActions.js";
...
export default connect(mapStateToProps, { removeFromCart, clearCart, increment,decrement })(
	CartDetailsPage
);
